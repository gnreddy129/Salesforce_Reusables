// Generated from: tests\features\salesforce_categories.feature
...
test.describe('Salesforce Category Management', () => {
  ...
  test.describe('Add new category', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@categories', '@regression'] }, async ({ Given, When, Then, context, page }) => { 
    ...
    test('Example #2', { tag: ['@mode:serial', '@categories', '@regression'] }, async ({ Given, When, Then, context, page }) => { 
      await Given('Open a browser and login to the sales force site', null, { context, page }); 
      await When('Search for "Categories" in app launcher', null, { page }); 
      await Then('Add new category with following details', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"Name"},{"value":"Test Cat B"}]},{"cells":[{"value":"Catalog"},{"value":"Sample Item B"}]},{"cells":[{"value":"ShowMenu"},{"value":"false"}]},{"cells":[{"value":"ParentCategory"},{"value":"--None--"}]},{"cells":[{"value":"Description"},{"value":"Auto-created test B"}]},{"cells":[{"value":"SortOrder"},{"value":"2"}]}]}}, { page }); 
      await Then('Verify category is created successfully with details', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"Name"},{"value":"Test Cat B"}]}]}}, { page }); 
    });
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\salesforce_categories.feature'), { scope: 'test', box: true }],
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":16,"pickleLine":23,"tags":["@mode:serial","@categories","@regression"],"steps":[{"pwStepLine":17,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":18,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Categories\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Categories\"","children":[{"start":12,"value":"Categories","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":19,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new category with following details","stepMatchArguments":[]},{"pwStepLine":20,"gherkinStepLine":16,"keywordType":"Outcome","textWithKeyword":"Then Verify category is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end