// Generated from: tests\features\Finance\salesforce_payment-gateway-logs.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Finance\\salesforce_payment-gateway-logs.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":30,"tags":["@mode:serial","@paymentgatewaylogs","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Payment Gateway Logs\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Payment Gateway Logs\"","children":[{"start":12,"value":"Payment Gateway Logs","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new payment gateway log with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"Then Verify payment gateway log is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end