// Generated from: tests\features\Finance\salesforce_refunds.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Finance\\salesforce_refunds.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":38,"tags":["@mode:serial","@platform","@refunds","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Refunds\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Refunds\"","children":[{"start":12,"value":"Refunds","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new refund with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":35,"keywordType":"Outcome","textWithKeyword":"Then Verify refund is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end