// Generated from: tests\features\Finance\f1\salesforce_payment-authorization.feature
...
test.describe('Salesforce Payment Authorizations Management', () => {
  ...
  test.describe('Create new Payment Authorization with different data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@paymentauthorizations', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Payment Authorizations"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Finance\\f1\\salesforce_payment-authorization.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":44,"tags":["@mode:serial","@paymentauthorizations","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Payment Authorizations\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Payment Authorizations\"","children":[{"start":12,"value":"Payment Authorizations","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Payment Authorizations\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Payment Authorizations\"","children":[{"start":26,"value":"Payment Authorizations","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new payment authorization with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":36,"keywordType":"Outcome","textWithKeyword":"Then Verify payment authorization is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end