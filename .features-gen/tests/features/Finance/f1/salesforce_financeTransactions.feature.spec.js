// Generated from: tests\features\Finance\f1\salesforce_financeTransactions.feature
...
test.describe('Finance Transactions', () => {
  ...
  test.describe('Create a new Finance Transaction and verify it is created', () => {
    ...
    test('Example #1', async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Finance Transactions"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Finance\\f1\\salesforce_financeTransactions.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":8,"pickleLine":37,"tags":[],"steps":[{"pwStepLine":9,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Search for \"Finance Transactions\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Finance Transactions\"","children":[{"start":12,"value":"Finance Transactions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":6,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Finance Transactions\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Finance Transactions\"","children":[{"start":26,"value":"Finance Transactions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":7,"keywordType":"Outcome","textWithKeyword":"Then Add new finance transaction with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":31,"keywordType":"Outcome","textWithKeyword":"Then Verify finance transaction is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end