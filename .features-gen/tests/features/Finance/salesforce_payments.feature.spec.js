...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Finance\\salesforce_payments.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":7,"pickleLine":5,"tags":["@mode:serial","@platform","@payments","@regression"],"steps":[{"pwStepLine":8,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":9,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Payments\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Payments\"","children":[{"start":12,"value":"Payments","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":10,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new payment with following details","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":43,"keywordType":"Outcome","textWithKeyword":"Then Verify payment is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end