// Generated from: tests\features\CustomerData\salesforce_authorization-form.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\salesforce_authorization-form.feature'), { scope: 'test', box: true }],
