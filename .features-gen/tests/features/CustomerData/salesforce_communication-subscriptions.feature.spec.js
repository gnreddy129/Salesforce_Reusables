// Generated from: tests\features\CustomerData\salesforce_communication-subscriptions.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\salesforce_communication-subscriptions.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":17,"tags":["@mode:serial","@customer","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Communication Subscriptions\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Communication Subscriptions\"","children":[{"start":12,"value":"Communication Subscriptions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new Communication Subscriptions with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":11,"keywordType":"Outcome","textWithKeyword":"Then Verify Communication Subscriptions is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end