// Generated from: tests\features\CustomerData\c2\salesforce_contact-point-type-consent.feature
...
test.describe('Salesforce Contact Point Type Consent Management', () => {
  ...
  test.describe('Create and Manage New Contact Point Type Consent with Different Data', () => {
    ...
    test('Example #1', { tag: ['@customer', '@regression', '@mode:serial'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Contact Point Type Consent"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\c2\\salesforce_contact-point-type-consent.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":33,"tags":["@customer","@regression","@mode:serial"],"steps":[{"pwStepLine":10,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":6,"keywordType":"Action","textWithKeyword":"When Search for \"Contact Point Type Consent\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Contact Point Type Consent\"","children":[{"start":12,"value":"Contact Point Type Consent","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":7,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Contact Point Type Consent\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Contact Point Type Consent\"","children":[{"start":26,"value":"Contact Point Type Consent","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new Contact Point Type Consent with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":27,"keywordType":"Outcome","textWithKeyword":"Then Verify Contact Point Type Consent is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end