// Generated from: tests\features\CustomerData\c2\salesforce_contact-requests.feature
...
test.describe('Salesforce Contact Requests Management', () => {
  ...
  test.describe('Create and Manage New Contact Requests with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@customer', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Contact Requests"', null, { page }); 
      ...
      await Then('Verify Contact Request is created successfully with details', null, { page }); 
    });
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\c2\\salesforce_contact-requests.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":22,"tags":["@mode:serial","@customer","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Contact Requests\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Contact Requests\"","children":[{"start":12,"value":"Contact Requests","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Contact Requests\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Contact Requests\"","children":[{"start":26,"value":"Contact Requests","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new Contact Request with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then Verify Contact Request is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end