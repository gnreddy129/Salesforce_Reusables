// Generated from: tests\features\CustomerData\salesforce_legal-entities.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\salesforce_legal-entities.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":25,"tags":["@mode:serial","@customer","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Legal Entities\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Legal Entities\"","children":[{"start":12,"value":"Legal Entities","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new Legal Entities with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":19,"keywordType":"Outcome","textWithKeyword":"Then Verify Legal Entities are created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end