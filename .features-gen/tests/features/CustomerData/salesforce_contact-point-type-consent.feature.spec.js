...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":31,"tags":["@customer","@regression","@mode:serial"],"steps":[{"pwStepLine":10,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":6,"keywordType":"Action","textWithKeyword":"When Search for \"Contact Point Type Consent\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Contact Point Type Consent\"","children":[{"start":12,"value":"Contact Point Type Consent","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":7,"keywordType":"Outcome","textWithKeyword":"Then Add new Contact Point Type Consent with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":25,"keywordType":"Outcome","textWithKeyword":"Then Verify Contact Point Type Consent is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end