// Generated from: tests\features\CustomerData\c3\salesforce_data-use-legal-basis.feature
...
test.describe('Salesforce Data Use Legal Basis Management', () => {
  ...
  test.describe('Create and Manage New Data Use Legal Basis with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@customer', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Data Use Legal Basis"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\CustomerData\\c3\\salesforce_data-use-legal-basis.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":20,"tags":["@mode:serial","@customer","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Data Use Legal Basis\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Data Use Legal Basis\"","children":[{"start":12,"value":"Data Use Legal Basis","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Data Use Legal Basis\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Data Use Legal Basis\"","children":[{"start":26,"value":"Data Use Legal Basis","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new Data Use Legal Basis with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":14,"keywordType":"Outcome","textWithKeyword":"Then Verify Data Use Legal Basis is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end