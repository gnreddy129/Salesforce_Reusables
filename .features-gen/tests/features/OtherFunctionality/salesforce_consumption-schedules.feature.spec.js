// Generated from: tests\features\OtherFunctionality\salesforce_consumption-schedules.feature
...
test.describe('Salesforce Consumption Schedule Creation', () => {
  ...
  test.describe('Create a new consumption schedule with various field combinations', () => {
    ...
    test('Example #1', { tag: ['@ConsumptionSchedule', '@OtherFunctionality', '@Smoke'] }, async ({ Given, When, And, page }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_consumption-schedules.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":8,"pickleLine":25,"tags":["@ConsumptionSchedule","@OtherFunctionality","@Smoke"],"steps":[{"pwStepLine":9,"gherkinStepLine":8,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":9,"keywordType":"Action","textWithKeyword":"When Search for \"Consumption Schedules\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Consumption Schedules\"","children":[{"start":12,"value":"Consumption Schedules","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":10,"keywordType":"Action","textWithKeyword":"When I create a new consumption schedule with the following details:","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":19,"keywordType":"Action","textWithKeyword":"And I should see the consumption schedule details","stepMatchArguments":[]}]},
]; // bdd-data-end