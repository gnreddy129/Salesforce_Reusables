// Generated from: tests\features\OtherFunctionality\salesforce_contacts.feature
...
test.describe('Salesforce Contact Management', () => {
  ...
  test.describe('Create and Manage New Contacts with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@contacts', '@regression'] }, async ({ Given, When, Then, page }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_contacts.feature'), { scope: 'test', box: true }],
