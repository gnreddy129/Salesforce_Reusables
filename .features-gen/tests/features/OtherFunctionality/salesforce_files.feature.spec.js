// Generated from: tests\features\OtherFunctionality\salesforce_files.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_files.feature'), { scope: 'test', box: true }],
