// Generated from: tests\features\OtherFunctionality\o4\salesforce_streaming-channels.feature
...
test.describe('Salesforce Streaming Channels Management', () => {
  ...
  test.describe('Create and Manage New Streaming Channel with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@otherfunctionality', '@streaming-channels', '@regression'] }, async ({ Given, When, Then, And, page }) => { 
      ...
      await Then('Click on "New" button of "Streaming Channels"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o4\\salesforce_streaming-channels.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":19,"tags":["@mode:serial","@otherfunctionality","@streaming-channels","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Streaming Channels\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Streaming Channels\"","children":[{"start":12,"value":"Streaming Channels","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Streaming Channels\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Streaming Channels\"","children":[{"start":26,"value":"Streaming Channels","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new streaming channel with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"And Verify Streaming Channel is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end