// Generated from: tests\features\OtherFunctionality\o3\salesforce_scorecards.feature
...
test.describe('Salesforce Scorecards Management', () => {
  ...
  test.describe('Create and Manage New Scorecard with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@otherfunctionality', '@scorecards', '@regression'] }, async ({ Given, When, Then, And, page }) => { 
      ...
      await Then('Click on "New" button of "Scorecards"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o3\\salesforce_scorecards.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":19,"tags":["@mode:serial","@otherfunctionality","@scorecards","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Scorecards\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Scorecards\"","children":[{"start":12,"value":"Scorecards","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Scorecards\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Scorecards\"","children":[{"start":26,"value":"Scorecards","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new scorecard with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"And Verify Scorecard is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end