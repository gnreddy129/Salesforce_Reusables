// Generated from: tests\features\OtherFunctionality\o3\salesforce_process-exceptions.feature
...
test.describe('Salesforce Process Exceptions Management', () => {
  ...
  test.describe('Add new process exception with comprehensive details', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@processexceptions', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Process Exceptions"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o3\\salesforce_process-exceptions.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":28,"tags":["@mode:serial","@processexceptions","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Process Exceptions\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Process Exceptions\"","children":[{"start":12,"value":"Process Exceptions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Process Exceptions\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Process Exceptions\"","children":[{"start":26,"value":"Process Exceptions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new process exception with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"Then Verify process exception is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end