// Generated from: tests\features\OtherFunctionality\o1\salesforce_business-brands.feature
...
test.describe('Salesforce Business Brands Management', () => {
  ...
  test.describe('Add new business brand', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@business-brands', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Business Brands"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o1\\salesforce_business-brands.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":19,"tags":["@mode:serial","@business-brands","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Business Brands\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Business Brands\"","children":[{"start":12,"value":"Business Brands","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Business Brands\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Business Brands\"","children":[{"start":26,"value":"Business Brands","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new business brand with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"Then Verify business brand is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end