// Generated from: tests\features\OtherFunctionality\salesforce_catalog.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_catalog.feature'), { scope: 'test', box: true }],
