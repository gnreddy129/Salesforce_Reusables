// Generated from: tests\features\OtherFunctionality\salesforce_list-emails.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_list-emails.feature'), { scope: 'test', box: true }],
