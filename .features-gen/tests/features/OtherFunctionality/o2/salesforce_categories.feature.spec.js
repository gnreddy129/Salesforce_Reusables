// Generated from: tests\features\OtherFunctionality\o2\salesforce_categories.feature
...
test.describe('Salesforce Category Management', () => {
  ...
  test.describe('Add new category', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@categories', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Categories"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o2\\salesforce_categories.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":23,"tags":["@mode:serial","@categories","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Categories\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Categories\"","children":[{"start":12,"value":"Categories","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Categories\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Categories\"","children":[{"start":26,"value":"Categories","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new category with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":17,"keywordType":"Outcome","textWithKeyword":"Then Verify category is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end