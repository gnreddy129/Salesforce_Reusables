// Generated from: tests\features\OtherFunctionality\o2\salesforce_contracts.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\o2\\salesforce_contracts.feature'), { scope: 'test', box: true }],
