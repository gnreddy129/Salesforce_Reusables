// Generated from: tests\features\OtherFunctionality\salesforce_work-step-templates.feature
...
test.describe('Salesforce Work Step Templates Creation', () => {
  ...
  test.describe('Create a new work step template with basic details', () => {
    ...
    test('Example #1', { tag: ['@WorkStepTemplates', '@OtherFunctionality', '@Smoke'] }, async ({ Given, When, And, page }) => { 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_work-step-templates.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":8,"pickleLine":22,"tags":["@WorkStepTemplates","@OtherFunctionality","@Smoke"],"steps":[{"pwStepLine":9,"gherkinStepLine":8,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":9,"keywordType":"Action","textWithKeyword":"When Search for \"Work Step Templates\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Work Step Templates\"","children":[{"start":12,"value":"Work Step Templates","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":10,"keywordType":"Action","textWithKeyword":"When I create a new work step template with the following details:","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":16,"keywordType":"Action","textWithKeyword":"And I should see the work step template creation success","stepMatchArguments":[]}]},
]; // bdd-data-end