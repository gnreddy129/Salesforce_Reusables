// Generated from: tests\features\OtherFunctionality\salesforce_appointment-categories.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\OtherFunctionality\\salesforce_appointment-categories.feature'), { scope: 'test', box: true }],
