// Generated from: tests\features\Service\sr2\salesforce_work-orders.feature
...
test.describe('Salesforce Work Orders Management', () => {
  ...
  test.describe('Create and Manage New Work Orders with Comprehensive Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@work-orders', '@regression', '@comprehensive'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Fill Work Orders fields with following details:', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"Status"},{"value":"New"}]},{"cells":[{"value":"Priority"},{"value":"Medium"}]},{"cells":[{"value":"ParentWorkOrder"},{"value":""}]},{"cells":[{"value":"Contact"},{"value":"John Smith"}]},{"cells":[{"value":"Account"},{"value":"Testing"}]},{"cells":[{"value":"Asset"},{"value":""}]},{"cells":[{"value":"Case"},{"value":""}]},{"cells":[{"value":"Entitlement"},{"value":""}]},{"cells":[{"value":"ServiceContract"},{"value":""}]},{"cells":[{"value":"Description"},{"value":"HVAC system maintenance required for building"}]},{"cells":[{"value":"Subject"},{"value":"HVAC System Maintenance"}]}]}}, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Service\\sr2\\salesforce_work-orders.feature'), { scope: 'test', box: true }],
