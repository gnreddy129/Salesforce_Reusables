// Generated from: tests\features\Service\sr1\salesforce_change-requests.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Service\\sr1\\salesforce_change-requests.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":8,"pickleLine":35,"tags":["@salesforce","@service","@change-requests","@smoke","@regression","@positive","@create","@priority-high"],"steps":[{"pwStepLine":9,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Change Requests\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Change Requests\"","children":[{"start":12,"value":"Change Requests","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Change Requests\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Change Requests\"","children":[{"start":26,"value":"Change Requests","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":9,"keywordType":"Action","textWithKeyword":"When Add new Change Request with the following details:","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":29,"keywordType":"Outcome","textWithKeyword":"Then Verify Change Request is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end