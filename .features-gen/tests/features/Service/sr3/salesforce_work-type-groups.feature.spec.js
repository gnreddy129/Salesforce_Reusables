// Generated from: tests\features\Service\sr3\salesforce_work-type-groups.feature
...
test.describe('Salesforce Work Type Groups Management', () => {
  ...
  test.describe('Add new work type group', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@worktypegroups', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Work Type Groups"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Service\\sr3\\salesforce_work-type-groups.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":18,"tags":["@mode:serial","@worktypegroups","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Work Type Groups\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Work Type Groups\"","children":[{"start":12,"value":"Work Type Groups","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Work Type Groups\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Work Type Groups\"","children":[{"start":26,"value":"Work Type Groups","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new work type group with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":14,"keywordType":"Outcome","textWithKeyword":"Then Verify work type group is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end