// Generated from: tests\features\Service\sr3\salesforce_work-types.feature
...
test.describe('Salesforce Work Types Management', () => {
  ...
  test.describe('Add new work type', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@worktypes', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Work Types"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Service\\sr3\\salesforce_work-types.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":27,"tags":["@mode:serial","@worktypes","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Work Types\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Work Types\"","children":[{"start":12,"value":"Work Types","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Work Types\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Work Types\"","children":[{"start":26,"value":"Work Types","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new work type with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":23,"keywordType":"Outcome","textWithKeyword":"Then Verify work type is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end