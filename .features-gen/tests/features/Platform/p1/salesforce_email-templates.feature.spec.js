// Generated from: tests\features\Platform\p1\salesforce_email-templates.feature
...
test.describe('Salesforce Email Templates Management', () => {
  ...
  test.describe('Create and Manage New Email Templates with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@platform', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Email Templates"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Platform\\p1\\salesforce_email-templates.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":24,"tags":["@mode:serial","@platform","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Email Templates\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Email Templates\"","children":[{"start":12,"value":"Email Templates","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Email Templates\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Email Templates\"","children":[{"start":26,"value":"Email Templates","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new Email Template with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then Verify Email Template is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end