// Generated from: tests\features\Platform\p2\salesforce_quick-texts.feature
...
test.describe('Salesforce Quick Texts Management', () => {
  ...
  test.describe('Create and Manage New Quick Texts with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@service', '@quick-texts', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Quick Text"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Platform\\p2\\salesforce_quick-texts.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":23,"tags":["@mode:serial","@service","@quick-texts","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Quick Text\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Quick Text\"","children":[{"start":12,"value":"Quick Text","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Quick Text\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Quick Text\"","children":[{"start":26,"value":"Quick Text","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new quick text with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":17,"keywordType":"Outcome","textWithKeyword":"Then Verify quick text is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end