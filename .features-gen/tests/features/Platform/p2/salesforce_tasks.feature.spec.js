// Generated from: tests\features\Platform\p2\salesforce_tasks.feature
...
test.describe('Salesforce Task Management', () => {
  ...
  test.describe('Create and Manage New Tasks with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@platform', '@tasks', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on Hidden "New" button of "Tasks"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Platform\\p2\\salesforce_tasks.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":24,"tags":["@mode:serial","@platform","@tasks","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Tasks\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Tasks\"","children":[{"start":12,"value":"Tasks","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on Hidden \"New\" button of \"Tasks\"","stepMatchArguments":[{"group":{"start":16,"value":"\"New\"","children":[{"start":17,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":32,"value":"\"Tasks\"","children":[{"start":33,"value":"Tasks","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new task with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then Verify task is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end