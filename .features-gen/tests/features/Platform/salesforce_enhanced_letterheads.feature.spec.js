// Generated from: tests\features\Platform\salesforce_enhanced_letterheads.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Platform\\salesforce_enhanced_letterheads.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":17,"tags":["@mode:serial","@enhanced-letterheads","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Enhanced Letterheads\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Enhanced Letterheads\"","children":[{"start":12,"value":"Enhanced Letterheads","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new enhanced letterhead with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"Then Verify enhanced letterhead is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end