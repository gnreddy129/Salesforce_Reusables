// Generated from: tests\features\Platform\salesforce_quick-texts.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Platform\\salesforce_quick-texts.feature'), { scope: 'test', box: true }],
