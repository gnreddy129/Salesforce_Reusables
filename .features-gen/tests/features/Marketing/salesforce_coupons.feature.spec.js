...
test.describe('Salesforce Coupons Management', () => {
  ...
  test.describe('Add new coupon', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@coupons', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Coupons"', null, { page }); 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":24,"tags":["@mode:serial","@coupons","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Coupons\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Coupons\"","children":[{"start":12,"value":"Coupons","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Coupons\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Coupons\"","children":[{"start":26,"value":"Coupons","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new coupon with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"Then Verify coupon is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end