...
test.describe('Salesforce Engagement Channel Types Management', () => {
  ...
  test.describe('Create and Manage New Engagement Channel Type with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@marketing', '@engagement-channel-types', '@regression'] }, async ({ Given, When, Then, And, page }) => { 
      ...
      await Then('Add new engagement channel type with following details', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"Name"},{"value":"Test Channel 1"}]},{"cells":[{"value":"Contact Point Type"},{"value":"Person"}]},{"cells":[{"value":"Active"},{"value":"true"}]},{"cells":[{"value":"Usage Type"},{"value":"Salesforce Scheduler"}]}]}}, { page }); 
