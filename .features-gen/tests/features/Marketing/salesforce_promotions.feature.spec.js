...
test.describe('Salesforce Promotions Management', () => {
  ...
  test.describe('Add new promotion', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@promotions', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Promotions"', null, { page }); 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":37,"tags":["@mode:serial","@promotions","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Promotions\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Promotions\"","children":[{"start":12,"value":"Promotions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Promotions\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Promotions\"","children":[{"start":26,"value":"Promotions","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new promotion with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":33,"keywordType":"Outcome","textWithKeyword":"Then Verify promotion is created successfully","stepMatchArguments":[]}]},
]; // bdd-data-end