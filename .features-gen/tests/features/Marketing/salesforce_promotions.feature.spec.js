...
test.describe('Salesforce Promotions Management', () => {
  ...
  test.describe('Add new promotion', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@promotions', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Add new promotion with following details', {"dataTable":{"rows":[{"cells":[{"value":"Name"},{"value":"Holiday Sale 2024"}]},{"cells":[{"value":"Description"},{"value":"Special holiday promotion for Q4"}]},{"cells":[{"value":"Objective"},{"value":"Increase sales during holiday season"}]},{"cells":[{"value":"Campaign"},{"value":"DM Campaign to Top Customers - Nov 12-23, 2001"}]},{"cells":[{"value":"Active"},{"value":"true"}]},{"cells":[{"value":"Display Name"},{"value":"Holiday 2024 - 15% Off"}]},{"cells":[{"value":"Commerce Promotion"},{"value":"true"}]},{"cells":[{"value":"Qualifier Criteria"},{"value":"All"}]},{"cells":[{"value":"Priority Number"},{"value":"1"}]},{"cells":[{"value":"Target Criteria"},{"value":"All"}]},{"cells":[{"value":"Exclude qualifying items from discounts"},{"value":"true"}]},{"cells":[{"value":"Discount Order"},{"value":"Least Expensive"}]},{"cells":[{"value":"Discount Restriction"},{"value":"Limit by Least Expensive Qualifying Product"}]},{"cells":[{"value":"Exclusivity Type"},{"value":"Global"}]},{"cells":[{"value":"Qualifying Criteria Not Required Per Application"},{"value":"true"}]},{"cells":[{"value":"Approaching Discount"},{"value":"true"}]},{"cells":[{"value":"Start Date"},{"value":"12/01/2024"}]},{"cells":[{"value":"Start Time"},{"value":"12:00 AM"}]},{"cells":[{"value":"End Date"},{"value":"12/31/2024"}]},{"cells":[{"value":"End Time"},{"value":"11:59 PM"}]},{"cells":[{"value":"Automatic"},{"value":"true"}]},{"cells":[{"value":"Tiered Promotion"},{"value":"true"}]},{"cells":[{"value":"Maximum Applications Per Cart"},{"value":"5"}]}]}}, { page }); 
