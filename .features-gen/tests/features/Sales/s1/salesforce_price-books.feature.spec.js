// Generated from: tests\features\Sales\s1\salesforce_price-books.feature
...
test.describe('Salesforce Price Books Management', () => {
  ...
  test.describe('Create and Manage New Price Books with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@sales', '@regression'] }, async ({ Given, When, Then, page }) => { 
      ...
      await Then('Click on "New" button of "Price Books"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Sales\\s1\\salesforce_price-books.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":20,"tags":["@mode:serial","@sales","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Price Books\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Price Books\"","children":[{"start":12,"value":"Price Books","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Price Books\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Price Books\"","children":[{"start":26,"value":"Price Books","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new Price Book with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":14,"keywordType":"Outcome","textWithKeyword":"Then Verify Price Book is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end