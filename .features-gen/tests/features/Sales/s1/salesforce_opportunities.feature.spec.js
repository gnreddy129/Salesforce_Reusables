// Generated from: tests\features\Sales\s1\salesforce_opportunities.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Sales\\s1\\salesforce_opportunities.feature'), { scope: 'test', box: true }],
