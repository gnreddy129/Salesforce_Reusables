// Generated from: tests\features\Sales\s1\salesforce_orders.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Sales\\s1\\salesforce_orders.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":36,"tags":["@mode:serial","@regression","@orders","@create"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Orders\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Orders\"","children":[{"start":12,"value":"Orders","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Orders\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Orders\"","children":[{"start":26,"value":"Orders","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Fill Orders fields with following details:","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":29,"keywordType":"Outcome","textWithKeyword":"Then Click on Save button of \"Order\"","stepMatchArguments":[{"group":{"start":24,"value":"\"Order\"","children":[{"start":25,"value":"Order","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":15,"gherkinStepLine":30,"keywordType":"Outcome","textWithKeyword":"Then Verify order is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end