// Generated from: tests\features\Sales\s1\salesforce_leads.feature
...
test.describe('Salesforce Leads Creation and Management', () => {
  ...
  test.describe('Create new leads with different test data', () => {
    ...
    test('Example #1', async ({ Given, When, Then, And, page }) => { 
      ...
      await And('Fill all fields of lead with following details:', {"dataTable":{"rows":[{"cells":[{"value":"Field Name"},{"value":"Value"}]},{"cells":[{"value":"First Name"},{"value":"Johnny"}]},{"cells":[{"value":"Last Name"},{"value":"Deep"}]},{"cells":[{"value":"Company"},{"value":"Tech Corp Ltd"}]},{"cells":[{"value":"Email"},{"value":""}]},{"cells":[{"value":"Phone"},{"value":"9876543210"}]},{"cells":[{"value":"Lead Status"},{"value":"Open - Not Contacted"}]},{"cells":[{"value":"Industry"},{"value":"Technology"}]}]}}, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Sales\\s1\\salesforce_leads.feature'), { scope: 'test', box: true }],
