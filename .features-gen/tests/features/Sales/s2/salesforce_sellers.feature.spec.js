// Generated from: tests\features\Sales\s2\salesforce_sellers.feature
...
test.describe('Salesforce Sellers Management', () => {
  ...
  test.describe('Create and Manage New Seller with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@sales', '@sellers', '@regression'] }, async ({ Given, When, Then, And, page }) => { 
      ...
      await Then('Click on "New" button of "Sellers"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Sales\\s2\\salesforce_sellers.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":24,"tags":["@mode:serial","@sales","@sellers","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Sellers\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Sellers\"","children":[{"start":12,"value":"Sellers","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Sellers\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Sellers\"","children":[{"start":26,"value":"Sellers","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new seller with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"And Verify Seller is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end