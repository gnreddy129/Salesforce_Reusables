// Generated from: tests\features\Inventory\salesforce_inventory-resevations.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Inventory\\salesforce_inventory-resevations.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":8,"pickleLine":20,"tags":[],"steps":[{"pwStepLine":9,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When Search for \"Inventory Reservations\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Inventory Reservations\"","children":[{"start":12,"value":"Inventory Reservations","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":11,"gherkinStepLine":6,"keywordType":"Outcome","textWithKeyword":"Then Add new inventory reservations with following details","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":14,"keywordType":"Outcome","textWithKeyword":"Then Verify inventory reservations is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end