// Generated from: tests\features\Inventory\i2\salesforce_shipping-carriers.feature
...
test.describe('Salesforce Shipping Carriers Management', () => {
  ...
  test.describe('Create and Manage New Shipping Carrier with Different Data', () => {
    ...
    test('Example #1', { tag: ['@mode:serial', '@inventory', '@shipping-carriers', '@regression'] }, async ({ Given, When, Then, And, page }) => { 
      ...
      await Then('Click on "New" button of "Shipping Carriers"', null, { page }); 
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Inventory\\i2\\salesforce_shipping-carriers.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":19,"tags":["@mode:serial","@inventory","@shipping-carriers","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Shipping Carriers\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Shipping Carriers\"","children":[{"start":12,"value":"Shipping Carriers","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Click on \"New\" button of \"Shipping Carriers\"","stepMatchArguments":[{"group":{"start":9,"value":"\"New\"","children":[{"start":10,"value":"New","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"},{"group":{"start":25,"value":"\"Shipping Carriers\"","children":[{"start":26,"value":"Shipping Carriers","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":13,"gherkinStepLine":9,"keywordType":"Outcome","textWithKeyword":"Then Add new shipping carrier with following details","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":13,"keywordType":"Outcome","textWithKeyword":"And Verify Shipping Carrier is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end