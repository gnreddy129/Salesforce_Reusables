// Generated from: tests\features\Inventory\salesforce_return-order.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Inventory\\salesforce_return-order.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":32,"tags":["@mode:serial","@returnorder","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Return Orders\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Return Orders\"","children":[{"start":12,"value":"Return Orders","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new return order with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"Then Verify return order is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end