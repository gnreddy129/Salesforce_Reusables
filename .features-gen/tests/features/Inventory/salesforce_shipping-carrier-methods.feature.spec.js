// Generated from: tests\features\Inventory\salesforce_shipping-carrier-methods.feature
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\Inventory\\salesforce_shipping-carrier-methods.feature'), { scope: 'test', box: true }],
  $bddFileData: [({}, use) => use(bddFileData), { scope: "test", box: true }],
});

const bddFileData = [ // bdd-data-start
  {"pwTestLine":9,"pickleLine":22,"tags":["@mode:serial","@inventory","@shipping-carrier-methods","@regression"],"steps":[{"pwStepLine":10,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Shipping Carrier Methods\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Shipping Carrier Methods\"","children":[{"start":12,"value":"Shipping Carrier Methods","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":12,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new shipping carrier method with following details","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":16,"keywordType":"Outcome","textWithKeyword":"And Verify Shipping Carrier Method is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end