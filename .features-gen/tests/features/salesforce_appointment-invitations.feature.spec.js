// Generated from: tests\features\salesforce_appointment-invitations.feature
...
test.describe('Appointment Invitations', () => {
  ...
  test.describe('Create an appointment invitation', () => {
    ...
    test('Example #2', { tag: ['@mode:serial', '@appointment', '@regression'] }, async ({ Given, When, Then, context, page }) => { 
      await Given('Open a browser and login to the sales force site', null, { context, page }); 
      await When('Search for "Appointment Invitations" in app launcher', null, { page }); 
      await Then('Add new appointment invitation with following details', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"BookingStartDate"},{"value":"29/11/2025"}]},{"cells":[{"value":"BookingEndDate"},{"value":"29/12/2025"}]},{"cells":[{"value":"URLExpirationDate"},{"value":"30/12/2025"}]},{"cells":[{"value":"Active"},{"value":"false"}]},{"cells":[{"value":"AppointmentTopic"},{"value":"Work Item A"}]},{"cells":[{"value":"ServiceTerritory"},{"value":"Service Territory A"}]}]}}, { page }); 
      await Then('Verify appointment invitation is created successfully with details', {"dataTable":{"rows":[{"cells":[{"value":"Field"},{"value":"Value"}]},{"cells":[{"value":"BookingStartDate"},{"value":"29/11/2025"}]}]}}, { page }); 
    });
...
test.use({
  ...
  $uri: [({}, use) => use('tests\\features\\salesforce_appointment-invitations.feature'), { scope: 'test', box: true }],
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":16,"pickleLine":23,"tags":["@mode:serial","@appointment","@regression"],"steps":[{"pwStepLine":17,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given Open a browser and login to the sales force site","stepMatchArguments":[]},{"pwStepLine":18,"gherkinStepLine":7,"keywordType":"Action","textWithKeyword":"When Search for \"Appointment Invitations\" in app launcher","stepMatchArguments":[{"group":{"start":11,"value":"\"Appointment Invitations\"","children":[{"start":12,"value":"Appointment Invitations","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":19,"gherkinStepLine":8,"keywordType":"Outcome","textWithKeyword":"Then Add new appointment invitation with following details","stepMatchArguments":[]},{"pwStepLine":20,"gherkinStepLine":16,"keywordType":"Outcome","textWithKeyword":"Then Verify appointment invitation is created successfully with details","stepMatchArguments":[]}]},
]; // bdd-data-end