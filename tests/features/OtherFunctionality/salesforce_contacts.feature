...
Feature: Salesforce Contact Management
  ...
  Scenario Outline: Create and Manage New Contacts with Different Data
    ...
    Examples:
      ...
      | Mr.        | Kartika   | Smith    | Test Account 1 | Sales Manager | +1234567890 | +1234567891 | +1987654321 | +1234567892 | +1234567893 | john.smith@test.com | Mary Johnson |    +1234567894 | Sales      | Web           | 1985-06-15 | Sarah Johnson | English,French | Primary   |   123 Main St | New York    | NY           |      10001 | USA            |  456 Work St | Brooklyn  | NY         |    10002 | USA          | Primary sales contact   |
  ...
  # @contacts @smoke
  # Scenario: Create Contact with Minimum Required Fields
  #   Given Open a browser and login to the sales force site
  #   When Search for "contacts" in app launcher
  #   Then Add new contact with following details
  #     | Field    | Value         |
