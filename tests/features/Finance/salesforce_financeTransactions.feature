Feature: Finance Transactions
  ...
  Scenario Outline: Create a new Finance Transaction and verify it is created
    ...
    Examples:
      ...
      | Burlington Textiles Corp of America | LE001       | Invoice             | Post an invoice | Other     |            1001 |               10 |            2 |                2 |    10015 |        11 |            5 | New    |     11/12/2024 |        10:00 AM |   10/12/2024 |      10:00 AM |                0 | AdminSystem       | FS0000001                      | FSIM00A                      | In Process                     |
