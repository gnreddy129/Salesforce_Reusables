Feature: Salesforce Refund Line Payment Creation
  ...
  Scenario Outline: Create a new refund line payment with various field combinations
    ...
    Then Click on "New" button of "Refund Line Payments"
    ...
    Examples:
      ...
      | R-000000001 | Applied | No               | P-000000002 | Automated test comment 1 |     50 | Testing           |                             | 12/12/2024 | 10:00 AM |    10/12/2024 |          10:30 AM |  05/11/2024 |        11:00 AM |               |                   |