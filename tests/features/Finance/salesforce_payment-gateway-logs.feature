...
Feature: Salesforce Payment Gateway Logs Management
  ...
  Scenario Outline: Add new payment gateway log with comprehensive details
    ...
    Examples:
      ...
      | Authorization   | Alternative Payment Method | PM_APM-000000001 |                | Success |  31/12/2024 |     9:30 AM | REF-2024-001           |               200 | Request approved successfully | AUTH-12345      | M              | Transaction Approved | Success              | SF-REF-001                | {"amount": 1000, "currency": "USD", "card": "4111111"} | {"status": "approved", "id": "TXN-001", "code": "00"} |
