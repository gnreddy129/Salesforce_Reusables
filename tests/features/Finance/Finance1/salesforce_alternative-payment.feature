Feature: Alternative Payment Method Management in Salesforce
  ...
  Scenario Outline: Create a new alternative payment method with complete details
    ...
    Then Click on "New" button of "Alternative Payment Methods"
    ...
    Examples:
      ...
      | Corporate Card 2025 |       | Testing | Active | External       | true    | Corp Inc    | 123 Main St | New York | South Australia | Australia |      10001 | Primary corporate payment method | 00:11:22:33:44:55 | 192.168.1.100 | 2125551234 | audit1@example.com |
