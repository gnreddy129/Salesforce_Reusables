...
Feature: Salesforce Change Requests Management
  ...
  Scenario: Create a new Change Request with all required fields
    ...
    Examples:
      ...
      | Critical Security Update | Update to address security | High       | Open   | High     | High   | Major          | Security Patch         | To mitigate security risks | High impact if not applied |                  10/10/2025 |                    10:00 AM |                11/11/2025 |                  12:00 PM | --None-- |       06/06/2025 |         02:00 PM | Approved for deployment |
      # | System Upgrade Change Request | Upgrade to latest version  | Medium     | In Review | High     | Medium | Minor          | System Upgrade         | To improve system performance | Medium impact if not applied |                  2024-07-05 |                    09:00 AM |                2024-07-05 |                  11:00 AM | Jane Smith |       2024-06-26 |         03:00 PM | Pending further review  |
