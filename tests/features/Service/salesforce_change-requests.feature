...
Feature: Salesforce Change Requests Management
  ...
  Scenario: Create a new Change Request with all required fields
    ...
    Examples:
      ...
      | Critical Security Update | Update to address security | High       | Open   | High     | High   | Major          | Security Patch         | To mitigate security risks | High impact if not applied |                  10/10/2025 |                    10:00 AM |                11/11/2025 |                  12:00 PM | Test5 lab |       06/06/2025 |         02:00 PM | Approved for deployment |